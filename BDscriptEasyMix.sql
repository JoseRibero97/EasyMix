...
CREATE TABLE proveedor(
    ...
    proveedor_contacto varchar(255) NOT NULL,
...
-- Tabla Receta
CREATE TABLE receta (
    receta_id INT AUTO_INCREMENT,
    nombre_producto_final VARCHAR(255) NOT NULL,
    PRIMARY KEY (receta_id)
);

-- Tabla Receta_Ingredientes
CREATE TABLE receta_ingredientes (
	Receta_Ingredientes_id INT AUTO_INCREMENT,
	producto_id INT,
    receta_id INT,
    cantidad DOUBLE NOT NULL,
    unidad_medida VARCHAR(255) NOT NULL,
    PRIMARY KEY (Receta_Ingredientes_id),
...
CREATE TABLE produccion (
    produccion_id INT AUTO_INCREMENT,
...
CREATE TABLE produccion_insumos (
	produccion_Insumo_Id INT auto_increment,
    produccion_id INT,
    producto_id INT,
    cantidad_requerida DOUBLE NOT NULL,
    suficiente BOOLEAN NOT NULL,
    PRIMARY KEY (produccion_Insumo_Id),
...
INSERT INTO usuario (usuario_nombre, usuario_email, contrasena) VALUES
...
INSERT INTO proveedor (proveedor_nombre, proveedor_contacto) VALUES
...
INSERT INTO producto (producto_nombre, descripcion, tipo, precio, marca, presentacion, cantidad_presentacion, medida_cantidad, usuario_id, proveedor_id) VALUES
...
INSERT INTO receta (nombre_producto_final) VALUES
...
INSERT INTO receta_ingredientes (producto_id, receta_id, cantidad, unidad_medida) VALUES
